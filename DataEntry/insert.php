...
$team=$_POST["team"];
$match=$_POST["match"];
$scout=(empty($_POST["scout"])) ? '':$_POST["scout"];
$autoGear=(empty($_POST["auto-gear"])) ? 'no':$_POST["auto-gear"];
...
$climb=(empty($_POST["climb"])) ? 'no attempt':$_POST["climb"];
...
if(!empty($team) || !empty($match) || !empty($autoPosition))
{
    ...
    $cvsData = $team . "," . $match . "," . $scout . "," . $autoGear . "," . $ballPickup . "," . $gearPickup . "," . $autoPosition . "," . $mobility . "," . $autokPa . "," . $autoAccuracy . "," . $teleGearsMade . "," . $teleGearsAttempted . "," . $telekPa . "," . $teleAccuracy . "," . $climb . ","  . $fouls . "," . $yellowCard . "," . $redCard . ",\"" . $comments .  "\"\n";
